...
original_folder_path = os.path.join(SCRIPT_DIR, 'SuryaOCR_ONNX')
quanted_folder_path = os.path.join(SCRIPT_DIR, 'SuryaOCR_Optimized')
...
use_openvino     = True                  # Set True for OpenVINO optimization.
