...
# Path Settings
# ==============================================================================
model_size = "350M"  # [350M, 1.2B]
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
original_folder_path = os.path.join(SCRIPT_DIR, 'LFM_ONNX')
quanted_folder_path = os.path.join(SCRIPT_DIR, 'LFM_Optimized')
...
model_names = [                                             # Recommended dtype:
    ...
    "LLM_Main",                                             # [int4, int8, float32, float16]
...
def _num_heads(model_size):
    if "350" in model_size:
        return 16
    elif "1.2" in model_size:
        return 32
    return 0
...
def process_single_model(
    ...
    # ------------------------------------------------------------------
        ...
        model = optimize_model(
            ...
            num_heads=_num_heads(model_size),
            hidden_size=_hidden_size(model_size),
            verbose=False,
            model_type='bert',
